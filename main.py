...
try:
    ...
    print("⚠️  Web search not available - install duckduckgo-search")
...
print("=" * 60)
print("🌟 Ultimate AI System v8.0 Starting...")
print("=" * 60)
print(f"✅ AI Engine: Ready ({ai_engine.ai_name or 'Unnamed'})")
print(f"✅ File Upload: Ready")
print(f"{'✅' if EMAIL_AVAILABLE else '❌'} Email Service: {'Ready' if EMAIL_AVAILABLE else 'Not available'}")
print(f"{'✅' if SEARCH_AVAILABLE else '❌'} Web Search: {'Ready' if SEARCH_AVAILABLE else 'Not installed'}")
print("=" * 60)
...
def upload_file():
    ...
    try:
        ...
        success, context_or_error = file_service.save_upload(file, file.filename)
